...
f60 30   1024 -7 1.7  74 2.05 38 2.06 16 1.52 30 1.52 12 2.05 724 2.05 130 1.7
...
;    Sta  Dur  Amp    Pitch  Bend  OutCh Accent
i60 29    0.1  10000  8.09   6     8     1.06
i60 +     0.2  .      8.04   6     8     1.06
i60 29.5  0.1  .      8.09   6     8     1.02
i60 +     0.2  .      8.04   6     8     1.02
i60 30.0  2.0  .      8.03   60    8     1.02
;i60 32.3  0.1  .      8.09   6     8     1.06
;i60  +    0.2  .      8.09   6     8     1.02
; Mixer 3=FadeIn, 5=FadeOut, 6=Const1, 7=Const.5, 8=Const0
;    Sta  Dur   Amp  Ch  Pan  Fader  OutCh
i100 10   35    .7   8   7    6      25
...
;    Sta  Dur   Amp    Fqc    Func  Attack  OutCh  Sus
i2  31.5  .2    10500  7.02   0     .040    1      0
i2   +    .22    8500  8.02   .     .020    .      . 
i2  32.0  1.0   16000  8.09   .     .020    .      .
;
i2  33.8  .2    10500  8.03   .     .020    .      .
i2   +    1.0    8500  8.04   .     .100    .      . 
i2  34.5  .5    12000  7.04   .     .020    .      .
i2  34.5  0.1   13000  7.10   .     .020    .      . 
i2  +     0.9   13000  7.11   .     .020    .      . 
i2  35.0  .2    10500  8.03   .     .020    .      .
i2  +    1.0    8500   8.04   .     .030    .      . 
;
i2  36.3  .2    10500  7.09   .     .020    .      .
i2   +    1.0    8500  7.07   .     .100    .      . 
i2  37.0  .5    12000  7.02   .     .020    .      .
i2  37.0  1.0   13000  7.09   .     .020    .      . 
i2  37.5  .2    10500  7.02   .     .020    .      .
i2  +    1.0    8500   8.04   .     .030    .      . 
;
i2  38.9  .2    10500  8.03   .     .020    .      .
i2   +    1.0    8500  8.02   .     .100    .      . 
i2  39.6  .5    12000  8.04   .     .020    .      .
i2  39.6  1.0   13000  7.11   .     .020    .      . 
i2  40.1  .2    10500  8.03   .     .020    .      .
i2  +    1.0    8500   8.04   .     .030    .      . 
;
i2  41.8  .5    10500  7.02   .     .040    1      0
i2  42.2  1.0   16000  8.11   .     .015    .      .
i2  43.0  .2    12000  8.00   .     .020    .      .
i2  43.2  .3    13000  8.02   .     .020    .      . 
i2  43.5  .5    10200  7.11   .     .020    .      .
i2  44.2  1.2   11500  8.07   .     .020    .      .
i2  45.7  2.5   12000  7.04   .     .020    .      .
i2  45.7  2.5   13000  7.11   .     .020    .      . 
i2  45.75 2.5   12050  8.04   .     .020    .      . 
; Lorenz Oscillator for Chorus
;   Sta  Dur    Amp   X    Y    Z     S    R   B      h(rate)  OutKCh Offset
i8  18.5  30     4     7.8  1.1  33.4  10   28  2.667  1        1      25
i8  18.5  30     4    14.1 20.7  26.6  10   28  2.667  1        2      26
; Guitar Chorus
...
; Mixer 3=FadeIn, 5=FadeOut, 6=Const1, 7=Const.5, 8=Const0
;    Sta  Dur  Amp  Ch  Pan  Fader  OutCh
i100 18.5  30   .8   2   6    6      20
i100 18.5  30   .8   3   8    6      .

; Large Room Reverb
;    Sta   Dur  Amp  InCh1 Gain1 InCh2 Gain2 InCh3 Gain3  
i105 0     50   0.6  20    1     23    1     25    1
...
;   Sta  Dur    Amp   X    Y    Z     S    R   B      h(rate)  OutKCh Offset
i8  0    50     .5    7.8  1.1  33.4  10   28  2.667  .70      3      .105
i8  .2   50     .5   14.1 20.7  26.6  10   28  2.667  .84      4      .112
i8  .4   50     .5   13.8 21.7  26.2  10   28  2.767  .90      5      .121
; Waves
...
i42 35.5  0.5    700  12.00  -2.7    82        .52     .     .
i42 36.2  0.5    600  12.00  -2.5    30        .80     .     .
;
...
i42 39.7  1.5    800  11.04   .8     15        .28     .     .
; Mixer 3=FadeIn, 5=FadeOut, 6=Const1, 7=Const.5, 8=Const0
;    Sta  Dur   Amp  Ch  Pan  Fader  OutCh
i100  0.0 50.0  1    4   4    6      20
i100  0.0 50.0  1    5   11   6      20
